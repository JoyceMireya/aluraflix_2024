    ...
    try {
      if (editingCategoria) {
        ...
        const response = await axios.put(
          `http://localhost:3001/categorias/${editingCategoria.id}`,
          data
        );
        console.log(response.data);
        console.log(response.status);
        ...
        <Container maxWidth="xl">
          <form onSubmit={handleSubmit(onSubmit)}>
            <Grid rowSpacing={5} container sx={{}}>
              <Grid item xs={12}>
                <Typography align="center" variant="h3" color="#ffffff">
                  {" "}
                  Nueva Categoria
                </Typography>
              </Grid>
              ...
              <Grid item xs={12}>
                <Controller
                  ...
                  control={control}
                  defaultValue={
                    editingCategoria ? editingCategoria.categoriaNombre : ""
                  }
              ...
              <Grid item xs={12}>
                <Controller
                  ...
                  control={control}
                  defaultValue={
                    editingCategoria ? editingCategoria.categoriaTexto : ""
                  }
              ...
              <Grid item xs={12}>
                ...
                <Controller
                  ...
                  control={control}
                  defaultValue={
                    editingCategoria ? editingCategoria.categoriaColor : ""
                  }
                  render={({ field }) => (
                    <div>
                      <HuePicker
              ...
              <Grid item xs={12}>
                <Controller
                  ...
                  control={control}
                  defaultValue={
                    editingCategoria ? editingCategoria.codigoSeguridad : ""
                  }
              ...
              >
                ...
                >
                  <Button sx={{ width: 150 }} color="primary" type="submit">
                    Guardar
                  </Button>
                  <Button
                    onClick={resetForm}
                    ...
                    <TableBody>
                      {categorias.map((row, index) => (
                        ...
                        >
                          ...
                          <TableCell>
                            <button onClick={() => editCategoria(row.id)}>
                              Editar
                            </button>
                          </TableCell>
                          <TableCell>
